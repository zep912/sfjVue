		...
		<div class="xianchang_content">
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">收文编号<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入申请人员"></el-input>
					
				</div>
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">收文时间<i></i></span><span class="name_span">*</span>
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">来文单位<i></i></span><span class="name_span" >*</span>
					<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入申请人员"></el-input>
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">公文种类<i></i></span><span class="name_span" >*</span>
					<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入申请人员"></el-input>
					
				</div>
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">来文文号<i></i></span><span class="name_span">*</span>
			...
			<div class="flex" style="align-items: flex-start;" >
				<span class="text_betten" style="line-height: 20px;">文件主要内容<i></i></span><span class="name_span" style="opacity: 0;">*</span>
				<textarea name="" id="" cols="30" rows="10"></textarea>
			</div>
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">公文文件<i></i></span><span class="name_span" >*</span>
					<el-button>浏览本地</el-button>
				</div>
			</div>
			<div class="flex" style="align-items: flex-start;margin: 15px  0;">
				<span class="text_betten">签收资料<i></i></span><span class="name_span" >*</span>
				<el-upload
