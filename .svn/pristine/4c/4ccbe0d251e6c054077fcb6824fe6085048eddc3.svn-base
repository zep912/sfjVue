	...
	<div class="p_conright">
		<div class="top_manalvs">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  ...
			  <el-breadcrumb-item>司机信息预览</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="xianchang_content">
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					...
					<div class="carnametext">12345</div>
				</div>
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">司机姓名<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<div class="carnametext">12345</div>
				</div>
			</div>
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">驾驶证号<i></i></span><span class="name_span" style="opacity: 0;" >*</span>
					<div class="carnametext">635267592356984</div>
				</div>
				<div class="flex" style="align-items: flex-start;">
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">内部小号<i></i></span><span class="name_span" style="opacity: 0;" >*</span>
					<div class="carnametext">白色</div>
				</div>
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">性别<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<div class="carnametext">男</div>
				</div>
			</div>
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">初次领证<i></i></span><span class="name_span" style="opacity: 0;" >*</span>
					<div class="carnametext">12345</div>
				</div>
				<div class="flex" style="align-items: flex-start;">
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">有效期至<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<div class="carnametext">12345</div>
				</div>
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">准驾车型<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<div class="carnametext">C1</div>
				</div>
			</div>
			<div class="shoujihoama1">
				<div class="flex">
					<span class="text_betten textduozi">照片<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<img src="../../assets/image/huic.jpg" class="car_img" alt="">
				</div>
			</div>
		</div>
	</div>
