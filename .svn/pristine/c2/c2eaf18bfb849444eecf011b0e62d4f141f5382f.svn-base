	...
	<div class="p_conright">
		<div class="top_manalvs">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  ...
			  <el-breadcrumb-item>新增司机</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="xianchang_content">
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">司机编号<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入司机编号"></el-input>
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">驾驶证号<i></i></span><span class="name_span" >*</span>
					<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入驾驶证号"></el-input>
					
				</div>
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">手机号码<i></i></span><span class="name_span">*</span>
					<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入手机号码"></el-input>
					
				</div>
			</div>
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">内部小号<i></i></span><span class="name_span" >*</span>
					<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入内部小号"></el-input>
					
				</div>
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">性别<i></i></span><span class="name_span" style="opacity: 0;">*</span>
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">初次领证<i></i></span><span class="name_span" >*</span>
					<el-date-picker
					  v-model="value1"
					  type="date"
					  placeholder="选择日期">
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">有效期至<i></i></span><span class="name_span">*</span>
					<el-date-picker
					  v-model="value1"
					  type="date"
					  placeholder="选择日期">
				...
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">准驾车型<i></i></span><span class="name_span">*</span>
			...
			<div class="shoujihoama1">
				<div class="flex">
					<span class="text_betten textduozi">上传照片<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<el-upload
