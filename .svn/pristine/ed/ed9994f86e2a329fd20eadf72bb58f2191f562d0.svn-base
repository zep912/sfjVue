<template>
    <div class="gerens">
        ...
        <div class="content_zwyou">
            ...
            <div class="zwyou_top">
                <div class="xuanzhong_biaoqian">人民调解预约</div>
                <div>共计：{{ownerMediateList.pageInfo.total}}篇</div>
            </div>
            <div class="zwyou_content">
                <div class="zwyou_conlist" v-for="(item,index) in ownerMediateList.dataList" :key="index">
                    <div class="zhengwugk">
            ...
            <div class="kevheng_fenye">
                <el-pagination
                        ...
                        :current-page.sync="getOwnerMediateContent.pageNum"
                        :page-size="getOwnerMediateContent.pageSize"
                        layout="prev, pager, next, jumper"
                        :total="ownerMediateList.pageInfo.total">
                </el-pagination>
            </div>
        </div>
    </div>
...
<script>
    import {getOwnerMediateList} from '../../../http/api';
    export default {
        data(){
            return{
                //问题类型
        ...
        mounted() {
            this.getOwnerMediateList();
        },
        methods: {
            getOwnerMediateList(){
                this.getOwnerMediateContent.token = this.token;
                getOwnerMediateList(this.getOwnerMediateContent).then(success=>{
                    this.ownerMediateList = success.content;
                    this.ownerMediateList.pageInfo.total = Number(this.ownerMediateList.pageInfo.total);
                })
            },
            ...
            handleCurrentChange(pageNum){
                this.getOwnerMediateContent.pageNum = pageNum;
                this.getOwnerMediateList();
            }
        },
    }
