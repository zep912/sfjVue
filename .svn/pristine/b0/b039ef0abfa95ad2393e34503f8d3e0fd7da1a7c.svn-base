	...
	<div class="p_conright">
		<div class="top_manalvs">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  ...
			  <el-breadcrumb-item>公文起草</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="xianchang_content">
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">公文标题<i></i></span><span class="name_span" >*</span>
					<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入申请人员"></el-input>
					
				</div>
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">发文单位<i></i></span><span class="name_span" style="opacity: 0;">*</span>
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">成文日期<i></i></span><span class="name_span" >*</span>
					<el-date-picker
					     v-model="value1"
					     type="date"
					     placeholder="选择日期">
				...
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">公文种类<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<el-select v-model="gongwenz" placeholder="请选择" style="width: 82%" @change="peixunsel()">
					    <el-option
					      v-for="item in gongwen"
					      :key="item.value"
					      :label="item.label"
					      :value="item.value">
					    </el-option>
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">申请文号<i></i></span><span class="name_span" >*</span>
					<el-select v-model="peixunseldata" placeholder="请选择" style="width: 82%;" @change="peixunsel()">
					    <el-option
			...
			<div class="flex" style="align-items: flex-start;">
				<span class="text_betten">公文名称<i></i></span><span class="name_span" >*</span>
				<el-input v-model="submitConsultLocale.consultData.personName" style="width: 82%;" placeholder="请输入培训主题"></el-input>
				
			</div>
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">密级<i></i></span><span class="name_span" >*</span>
					<el-select v-model="miji" placeholder="请选择" style="width: 41%;" @change="peixunsel()">
					    <el-option
					      v-for="item in mijis"
					      :key="item.value"
					      :label="item.label"
					...
					<el-select v-model="peixunseldata" placeholder="请选择" style="width: 40%;margin-left: 1%;" @change="peixunsel()">
					    <el-option
					      v-for="item in yongchetime"
					      :key="item.value"
					      :label="item.label"
				...
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">紧急程度<i></i></span><span class="name_span" >*</span>
					<el-select v-model="miji" placeholder="请选择" style="width: 82%;" @change="peixunsel()">
					    <el-option
					      v-for="item in mijis"
					      :key="item.value"
					      :label="item.label"
			...
			<div class="shoujihoama1">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">文件级别<i></i></span><span class="name_span" >*</span>
					<el-select v-model="miji" placeholder="请选择" style="width: 82%;" @change="peixunsel()">
					    <el-option
					      v-for="item in mijis"
					      :key="item.value"
				...
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">发文类型<i></i></span><span class="name_span" >*</span>
					<div style="padding: 15px 0;">
						<el-radio v-model="radio" label="1">通知类</el-radio>
						<el-radio v-model="radio" label="2">审批类</el-radio>
						<el-radio v-model="radio" label="3">公告类</el-radio>
					</div>
				</div>
			</div>
			<div class="flex" style="align-items: flex-start;" >
				<span class="text_betten" style="line-height: 20px;">主题词<i></i></span><span class="name_span" style="opacity: 0;">*</span>
