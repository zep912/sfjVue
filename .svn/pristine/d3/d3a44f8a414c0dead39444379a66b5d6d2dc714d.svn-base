	...
	<div class="xinzeng_zhengwu">
		<div class="top_manalvs">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  ...
			  <el-breadcrumb-item :to="{path:'/zhengwugongkai'}">政务公开</el-breadcrumb-item>
			  <el-breadcrumb-item :to="{path:'/sifa_kaoshi'}" v-if="newsType == '8'">司法考试</el-breadcrumb-item>
		...
		<!-- <div class="qingjia_neirong">
			<div class="flex" style="align-items: flex-start;">
				...
				<el-input v-model="chuandata.newsTitle" style="width: 82%;" placeholder="请输入标题"></el-input>
			</div>
			<div class="shoujihoama1" style="margin: 20px 0;">
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">来源<i></i></span><span class="name_span">*</span>
					<el-select v-model="chuandata.laiyuan" placeholder="请选择" style="width: 82%;">
					    <el-option
				...
				<div class="flex" style="align-items: flex-start;">
					<span class="text_betten">作者<i></i></span><span class="name_span" style="opacity: 0;">*</span>
					<el-input v-model="chuandata.zuozhe" style="width: 82%;" placeholder="请输入作者姓名"></el-input>
				</div>
			</div>
			<div class="flex" style="align-items: flex-start;">
				<span class="text_betten">发布时间<i></i></span><span class="name_span">*</span>
				<el-date-picker
				      v-model="chuandata.publishTime"
				      type="datetime"
				      placeholder="选择日期时间">
				</el-date-picker>
			</div>
			<div class="flex" style="align-items: flex-start;margin-top: 20px;">
				<span class="text_betten">内容<i></i></span><span class="name_span">*</span>
				<div id="wangeditor" style="width: 82%">
		...
		<div class="formWrap">
			<el-form :model="form" :rules="rules" ref="form">
				<el-row :gutter="20" style="margin-top:20px;">
					<el-col :span="24">
						<el-form-item class="itemWrap"  prop="title">
							...
							<el-input :disabled="true" maxlength="100" v-model="form.title" placeholder="辽阳市司法局主要机构设置"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="0">
					<el-col :span="10">
						<el-form-item class="itemWrap"  prop="laiyuan">
							...
							<el-input :disabled="true" maxlength="100" v-model="form.laiyuan" placeholder="输入来源"></el-input>
					...
					<el-col :span="10" :offset="4">
						<el-form-item class="itemWrap"  prop="auther">
							...
							<el-input :disabled="true" maxlength="100" v-model="form.auther" placeholder="作者"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
                ...
                <el-select :disabled="true" v-model="form.newsClassify" placeholder="请选择" style="width: 100%;">
                  <el-option
                    v-for="item in options"
                    :key="item.dictDataCode"
                    :label="item.dictDataName"
					...
					<el-col :span="24">
						<el-form-item class="itemWrap"  prop="newsContent">
							...
							<div id="wangeditor" style="width: 100%">
								...
								:showEditorValidate="showEditorValidate"
								:disable="true"></wangeditor>
							</div>
						</el-form-item>
					</el-col>
				</el-row>
				...
				<div style="display: flex;align-items: center;justify-content: center;margin-top: 50px;">
					<el-button type="primary" @click="baocun">返回列表</el-button>
	...
	export default {
      ...
      if(this.editId){
		...
		methods:{
			...
			// 				// "publishStatus":"1",                //类型：String  可有字段  备注：发布状态 1：未发布；2：已发布；
