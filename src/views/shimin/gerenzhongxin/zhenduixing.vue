<template>
    <div class="gerens">
        ...
        <div class="content_zwyou">
            ...
            <div class="zwyou_top">
                <div class="xuanzhong_biaoqian">针对性咨询</div>
                <div>共计：{{ownerConsultList.pageInfo.total}}篇</div>
            </div>
            <div class="zwyou_content" v-for="(item,index) in ownerConsultList.dataList" :key="index" @click="zhenduixing(item.consultId)">
